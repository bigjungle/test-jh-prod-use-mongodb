...
public class RegnCancResource {
    ...
    public RegnCancResource(RegnCancService regnCancService) {
    ...
    public ResponseEntity<List<RegnCancDTO>> getAllRegnCancs(Pageable pageable) {
        log.debug("REST request to get a page of RegnCancs");
        Page<RegnCancDTO> page = regnCancService.findAll(pageable);
    ...
    public ResponseEntity<RegnCancDTO> getRegnCanc(@PathVariable String id) {
    ...
    public ResponseEntity<Void> deleteRegnCanc(@PathVariable String id) {
