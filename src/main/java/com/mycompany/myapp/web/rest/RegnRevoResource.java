...
public class RegnRevoResource {
    ...
    public RegnRevoResource(RegnRevoService regnRevoService) {
    ...
    public ResponseEntity<List<RegnRevoDTO>> getAllRegnRevos(Pageable pageable) {
        log.debug("REST request to get a page of RegnRevos");
        Page<RegnRevoDTO> page = regnRevoService.findAll(pageable);
    ...
    public ResponseEntity<RegnRevoDTO> getRegnRevo(@PathVariable String id) {
    ...
    public ResponseEntity<Void> deleteRegnRevo(@PathVariable String id) {
